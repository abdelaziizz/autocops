...
public interface InstitutionConfigMappingService {
    ...
    InstitutionsConfigMapping create(long configId, int imp_field_index, long typeId, long exp_field, long imp_field, Integer start_index, Integer last_index);

    InstitutionsConfigMapping delete(long id);

    InstitutionsConfigMapping put(long id, long configId, int imp_field_index, long typeId, long exp_field, long imp_field, int start_index, int last_index);
